...
public class TambahDataSetWajahActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
                    ...
                    if ((faces != null) && (faces.length == 1)) {
                        ...
                        if (((method == MANUALLY) && capturePressed) || (method == TIME)) {
                            ...
                            if (total == numberOfPictures) {
                                Intent returnIntent = new Intent(TambahDataSetWajahActivity.this, KelolaDataSetWajahActivity.class);
