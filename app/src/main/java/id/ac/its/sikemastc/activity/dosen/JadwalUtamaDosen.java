...
public class JadwalUtamaDosen extends BaseActivity implements
        JadwalUtamaMkAdapter.JadwalUtamaMkAdapterOnClickHandler {

    private final String TAG = JadwalUtamaDosen.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadwal_utama_dosen);
        mContext = this;
...
//        String tag_string_req = "req_list_jadwal_kelas_utama";
