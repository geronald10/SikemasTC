...
public class HasilVerifikasiActivity extends AppCompatActivity {

    private final String TAG = HasilVerifikasiActivity.class.getSimpleName();
...
//                    startActivity(intentToMenuVerifikasi);
                ...
                case R.id.btn_menu_utama:
                    Intent intentToHome = new Intent(HasilVerifikasiActivity.this, HalamanUtamaMahasiswa.class);
